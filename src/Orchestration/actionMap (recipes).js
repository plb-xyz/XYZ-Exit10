...
// Action style (as requested):
//   { type: 'watchout', command: 'startTimeline', timelineKey: 'show_1' }
//   { type: 'watchout', command: 'GotoCue', timelineKey: 'show_1', cueKey: 'cue_special' }
//
// Notes:
...
const recipes = {
  show_1: [
    ...
    { type: 'watchout', command: 'GotoCue', timelineKey: 'show_1', cueKey: 'intro', waitMs: 300 },
