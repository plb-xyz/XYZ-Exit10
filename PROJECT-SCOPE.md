...
- **Ambiences = per-space flexibility, BG operation**
...
- Scope: Generally runs system-wide, but supports different ambiences per space simultaneously.
...
### SPECIAL CONTENT
Full Screen
- **Behavior:** Custom content (ambience-like), can take over Atriums 1–3 (selectively includes sphere/column).
- **Audio:** May have special audio (else BG music continues).

#### On Top
- **Behavior:** Overlay 16:9 video(s) on top of ambience (ribbon, column; rarely sphere).
- **Audio:** If present, fades out BG music, plays its own, then fades BG music back in after; if not, only video overlays.

## SOURCES OVERVIEW
- **Video:** Always from Watchout; can be show, ambience, event, or special content.
- **Audio:** 
...
- **Lighting:** 
  ...
  - Ambience/Simple Event/On Top Content: triggered by cues
